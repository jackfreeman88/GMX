 ...
 *   https://datatables.net/download/#bs4/dt-1.10.21/b-1.6.3/fh-3.1.7/r-2.2.5
 *
 * Included libraries:
 *   DataTables 1.10.21, Buttons 1.6.3, FixedHeader 3.1.7, Responsive 2.2.5
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.21/b-1.6.3/fh-3.1.7/r-2.2.5",
...
$.extend( true, DataTable.Buttons.defaults, {
	...
	buttonCreated: function ( config, button ) {
		return config.buttons ?
			$('<div class="btn btn-rounded-group"/>').append(button) :
			button;
	}
} );

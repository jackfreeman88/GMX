...
<div class="user-wrap">
    ...
    @else 
        @php $id = 0 @endphp
    @endif
    {!! Form::open(['url'=>url($actionURL.'/action',$view).'/'.$id,'files'=>true,'id'=>'sallerform']) !!}
        ...
        <div class="card-body">
            <div class="form-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="col-form-label fs-14">Brand Name </label>
                            <input type="text" name="brandName" class="form-control fs-14" value="{{ $data->brandName ?? '' }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="col-form-label fs-14">Website </label>
                            <input type="text" name="website" class="form-control fs-14" value="{{ $brandDetails->website ?? '' }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="col-form-label fs-14">Business Establishment Year </label>
                            <input type="text" name="year" class="form-control fs-14 numbersOnly" value="{{ $brandDetails->year ?? '0' }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="col-form-label fs-14">Average Order Per Month </label>
                            <input type="text" name="avgOrder" class="form-control fs-14 numbersOnly" value="{{ $brandDetails->avgOrder ?? '0' }}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="col-form-label fs-14">License Expire Date </label>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="col-form-label fs-14">Address </label>
                            <input type="text" name="address" class="form-control fs-14" value="{{ $brandDetails->address ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control fs-14">{{ $brandDetails->description ?? '' }}</textarea>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex text-center">
                                                        @if($brand->isActive=='1')
                                                            <a title="Make Inactive" href="{{url($actionURL.'/action/makeInactive/'.$brand->id)}}"><i class="fas fa-check fs-18 text-success"></i></a>
                                                        @else
                                                            <a title="Make Active" href="{{url($actionURL.'/action/makeActive/'.$brand->id)}}"><i class="fas fa-times-circle fs-18 color-0799c4"></i></a>
                                                        @endif
                                                        <span class="mx-1">|</span>
                                                        <a title="Edit" href="{{url($actionURL.'/edit/'.$brand->id)}}"><i class="fas fa-edit text-success fs-18"></i> </a>
                                                        {{--<span class="mx-1">|</span>
                                                        <a title="Delete" href="javascript:void(0)" onclick="gmx_modal.confirmModal('{{ url($actionURL.'/action/delete/'.$brand->id) }}');"><i class="fas fa-trash-alt fs-18 text-danger"></i>
                                                        </a> --}}
                                                    </div>
                                                </td>
                                            </tr>

...
<div class="user-wrap">
    ...
    @else 
        @php $id = 0 @endphp
    @endif
    {!! Form::open(['url'=>url($actionURL.'/action',$view).'/'.$id,'files'=>true,'id'=>'strainform']) !!}
                    ...
                    <div class="row justify-content-lg-end">
                        ...
                        <div class="form-group">
                            ...
                            @if( isset($data['filter']) && !empty($data['filter']) )
                                <a href="{{ url('strain') }}" data-toggle="tooltip" title="Clear" class="btn btn-secondary1 btn-wh-50-46 br-6"><i class="fas fa-times-circle"></i></a>
                            @endif
                        </div>
                    </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex text-center">
                                                        ...
                                                        <a title="Delete" href="javascript:void(0)" onclick="gmx_modal.confirmModal('{{ url($actionURL.'/action/delete/'.$strain->id) }}');"><i class="fas fa-trash-alt fs-18 text-danger"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>

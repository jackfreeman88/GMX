...
<div class="user-wrap">
    ...
    @else 
        @php $id = 0 @endphp
    @endif
    {!! Form::open(['url'=>url($actionURL.'/action',$view).'/'.$id,'files'=>true,'id'=>'categoryform']) !!}
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{ $data->title ?? '' }}" class="form-control fs-14" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
    ...
    <div class="user-wrap">
        <div class="card bs-4 mb-3 card-dark">
            <div class="card-body">
                ...
                {!! Form::open(['url'=>url($actionURL),'method'=>'get','id'=>'categoryFilter']) !!}
                    <div class="row justify-content-lg-end">
                        ...
                        <div class="form-group">
                            ...
                            @if( isset($data['filter']) && !empty($data['filter']) )
                                <a href="{{ url('categories') }}" data-toggle="tooltip" title="Clear" class="btn btn-secondary1 btn-wh-50-46 br-6"><i class="fas fa-times-circle"></i></a>
                            @endif
                        </div>
                    </div>
                    </div>
                                                ...
                                                <td>
                                                    <div class="d-flex text-center">
                                                        @if($category->isActive=='1')
                                                            <a title="Make Inactive" href="{{url($actionURL.'/action/makeInactive/'.$category->id)}}"><i class="fas fa-check fs-18 text-success"></i></a>
                                                        @else
                                                            <a title="Make Active" href="{{url($actionURL.'/action/makeActive/'.$category->id)}}"><i class="fas fa-times-circle fs-18 color-0799c4"></i></a>
                                                        @endif
                                                        <span class="mx-1">|</span>
                                                        <a title="Edit" href="{{url($actionURL.'/edit/'.$category->id)}}"><i class="fas fa-edit text-success fs-18"></i> </a>
                                                        <span class="mx-1">|</span>
                                                        <a title="Delete" href="javascript:void(0)" onclick="gmx_modal.confirmModal('{{ url($actionURL.'/action/delete/'.$category->id) }}');"><i class="fas fa-trash-alt fs-18 text-danger"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>

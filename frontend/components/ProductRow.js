...
function ProductRow({ product: initialProduct, handleStatusChange, handleCategoryFilter, isLastRow }) {
    ...
    return (
        (isEditable === false)
            ?
            <Tr>
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white">{Helper.niceString(product.title, 20, true)}</a></Link></Td>
                <Td>
                ...
                <Td> <Link href={`/product/edit/${product.slug}`}><a className="text-white">{product.medRec?.title}</a></Link></Td>
                {/* <Td>{product.productPrice}</Td> */}
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white"> {product.strain?.title}</a></Link></Td>
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white"> {product.thc}%</a></Link></Td>
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white"> {product.flavor}</a></Link></Td>
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white"> {Helper.niceString(product.dominant, 20, true)}</a></Link></Td>
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white"> {product.io?.title}</a></Link></Td>
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white"> {product.niceHarvested}</a></Link></Td>
                <Td><Link href={`/product/edit/${product.slug}`}><a className="text-white"> {Helper.niceString(product.unit, 20, true)}</a></Link></Td>
                <Td>
                    ...
                    <Link href={`/product/edit/${product.slug}`}><a className="action-btn color-22a612"><FontAwesomeIcon icon={faEdit} /></a>
                    </Link>

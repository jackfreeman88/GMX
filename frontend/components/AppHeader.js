                    ...
                    <Container>
                                ...
                                <NavDropdown title={getSingle('userName')} align="end" id="basic-nav-dropdown">
                                    {getSingle('role') === '2' ?
                                        <>
                                            ...
                                            <Link href="/quote-requests" passHref>
                                            ...
                                            <Link href="/account/seller" passHref>
                                        ...
                                        <>
                                            ...
                                            <Link href="/products/favourites" passHref>
                                            ...
                                            <Link href="/requested-quotes" passHref>
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className="mx-auto">
                                <Link href="/" passHref><Nav.Link eventKey='/' onClick={closeNav} active={router.pathname === '/'}>Home <span></span> </Nav.Link></Link>
                                <Link href="/about-us" passHref><Nav.Link active={router.pathname === '/about-us'} onClick={closeNav}>About Us <span></span></Nav.Link></Link>
                                <Link href={"/products"} passHref><Nav.Link active={(router.pathname === '/products' || router.pathname === '/product/[slug]')} onClick={closeNav}>Products <span></span></Nav.Link></Link>
                                {/* <Link href='/blogs' passHref><Nav.Link onClick={closeNav}>Blogs</Nav.Link></Link> */}
                                <Link href="/brands" passHref><Nav.Link onClick={closeNav} active={(router.pathname === '/brands' || router.pathname === '/brand/[slug]')}>Brands<span></span></Nav.Link></Link>
                                <Link href="/retailers" passHref><Nav.Link onClick={closeNav} active={(router.pathname === '/retailers' || router.pathname === '/customer/[slug]')}>Retailers<span></span></Nav.Link></Link>
                                {
                                    loggedInUser ?
                                        <Link href={"/axis-point"} passHref><Nav.Link active={(router.pathname === '/axis-point')} onClick={closeNav}>Axis Point <span></span></Nav.Link></Link>
                                        : null
                                }
                                <Link href="/contact-us" passHref><Nav.Link onClick={closeNav} active={router.pathname === '/contact-us'}>Contact Us <span></span></Nav.Link></Link>
                            </Nav>
                            {
                                !loggedInUser
                                    ?
                                    <>
                                        <Nav className="btn-group">
                                            <Link href="/sign-in"><a className="btn btn-secondary" onClick={closeNav}>Sign In</a></Link>
                                            <Link href="/sign-up"><a className="btn btn-secondary" onClick={closeNav}>Sign Up</a></Link>
                                        </Nav>
                                    </>
                                    :
                                        ...
                                        <NavDropdown title={getSingle('userName')} align="end" id="basic-nav-dropdown">
                                            {getSingle('role') === '2' ?
                                                ...
                                                <>
                                                    ...
                                                    <Link href={`/customer/${getSingle('slug')}`} passHref>

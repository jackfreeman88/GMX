                                                    ...
                                                    showSkeleton ?
                                                        ...
                                                        favProducts.length ?
                                                            favProducts.map((favProduct) => {
                                                                return (<Tr key={favProduct.id}>
                                                                    <Td>
                                                                        <Link href={"/brand/" + favProduct.product.user.brand.slug}><a className="color-f3772c text-decoration-none">{favProduct.product.user && favProduct.product.user.brand ? Helper.niceString(favProduct.product.user.brand.brandName, 20, true) : 'N/A'}</a></Link>
                                                                    </Td>
                                                                    <Td>
                                                                        <Link href={"/product/" + favProduct.product.slug}><a className="color-0e9bfd text-decoration-underline">{Helper.niceString(favProduct.product.title, 20, true)}</a></Link>
                                                                    </Td>

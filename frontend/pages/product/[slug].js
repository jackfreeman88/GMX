                                            ...
                                            {props.isLoggedIn && getSingle('role') !== '2' ?
                                                <>
                                                    ...
                                                    <ul className="d-flex align-items-center justify-content-between flex-wrap border-left-greenlight m-l-20">
                                                        ...
                                                        <li>
                                                            <Link
                                                                href={"/messages/" + props.productDetail.brandSlug}
                                                                className="w-37 h-37 b-w-2 btn-circle color-f3772c b-c-f3772c d-inline-b text-center m-l-20"
                                                                legacyBehavior>
                                                ...
                                                getSingle('role') !== '2' ?
                                                    <Link
                                                        href="/sign-in"
                                                        className="btn-primary btn-wh-188-51 btn br-30"
                                                        legacyBehavior><span><i className="icon-user-view"></i></span>Request Quote</Link>
                                                    : null
                                            }
                                        </div>
                                    </li>
                                        ...
                                        <ul className="product-detail-listing-wrap">
                                            ...
                                            <li className="product-quality-wrap text-right">
                                                <div className="d-flex justify-content-end flex-wrap">
                                                    ...
                                                    {props.isLoggedIn ?
                                                        <Link
                                                            href={"/brand/" + props.productDetail.brandSlug}
                                                            className="btn-wh-188-38 btn br-30 btn-gray mt-15"
                                                            legacyBehavior>
                                                             <span><i className="icon-user-view"></i></span>View Brand
                                                        </Link>
                                                        :
                                                        <Link
                                                            href="/sign-in"

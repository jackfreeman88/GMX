                                                            ...
                                                            orders.map((order) => {
                                                                return (<Tr key={order.id}>
                                                                    ...
                                                                    <Td className="text-start">
                                                                        <Link href={`/product/${order.product.slug}`}><a className="fs-16 fw-600 color-f3772c">{order.product?.title ? Helper.niceString(order.product?.title, 15, true) : ''}</a></Link>
                                                                        <p className="fs-14 fw-400 color-bfbfbf">{order.category?.title ?? ''}</p>
                                                                        <Link href={`/brand/${order.brand.slug}`}><a className="color-0e9bfd text-decoration-underline">{order.brand ? Helper.niceString(order.brand.brandName, 20, true) : ''}</a></Link>
                                                                    </Td>
                                                                    ...
                                                                    <Td className="text-right">
                                                                        <div className="d-flex justify-content-end align-items-center">
                                                                            <Link href={`/messages/${order.brand.slug}`}>
                                                                                <a className="btn-rounded w-30 h-30 btn-outline-secondary-transparent table-chat-btn text-center me-auto">

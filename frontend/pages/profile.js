                                                    ...
                                                    products.length > 0 ?
                                                        products.map((rowData, keyIndex) => (
                                                            <Tr key={keyIndex + "product"}>
                                                                <Td>
                                                                    <Link href={"/product/" + rowData.slug} className="color-f3772c" legacyBehavior>
                                                                        {Helper.niceString(rowData.title, 15)}
                                                                    </Link>
                                                                </Td>
                                                                <Td className="text-center">
                                                                    <Link href="#" className="color-white text-decoration-none" legacyBehavior>{rowData.category?.title}</Link>
                                                                </Td>

...
function PrivacyPolicy({ cmsData }) {
                    ...
                    <Container>
                        <div className="p-b-30 m-l-r-30">
                            <div className="content-box">
                                <p>Last modified: {dateTimeFormat(cmsData.updatedAt, "DD MMM YYYY")}</p>
...
export const getServerSideProps = async () => {
    try {
        const response = await Rest.axiosRequest(API.getCmsData + '/privacy-policy', {}, 'GET')
